...
from datasets import pascalvoc_to_tfrecords,transport_to_tfrecords
...
def main(_):
    ...
    elif FLAGS.dataset_name == 'transport':
        transport_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    else:
