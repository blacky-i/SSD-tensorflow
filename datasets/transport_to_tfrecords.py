"""Converts Transport data to TFRecords file format with Example protos.
...
from datasets.transport_common import VOC_LABELS
...
DIRECTORY_IMAGES - Directory name with images
DIRECTORY_ANNOTATIONS - Directory name with annotations
SAMPLES_PER_FILES - number of examples per file
"""
...
def _process_image(directory, name):
    ...
    filename = os.path.join(directory, DIRECTORY_ANNOTATIONS, name + '.json')
